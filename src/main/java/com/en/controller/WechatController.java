...
public class WechatController {
    ...
    public void authorizeTest(@RequestParam("code") String code) {
        log.info("进入autorize。。。");
        log.info("code={}", code);
        /*String openId = "oefE506WCHcjdmvO2DveYogLMXSA";
        String s = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx4a938cdc2d10abed&" +
                "redirect_uri=http://effortn.s1.natapp.cc/sell/wechat/authorize/test&" +
                "response_type=code&scope=snsapi_base&state=STATE#wechat_redirect";*/
        RestTemplate restTemplate = new RestTemplate();
        String url = "https://api.weixin.qq.com/sns/oauth2/access_token?" +
                "appid=wx4a938cdc2d10abed&secret=89b953b7c9e71f8ec96da57256fb2be6&code=" + code + "&grant_type=authorization_code";
